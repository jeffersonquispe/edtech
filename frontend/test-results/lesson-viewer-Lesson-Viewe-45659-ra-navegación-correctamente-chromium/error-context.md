...
- Name: lesson-viewer.spec.ts >> Lesson Viewer >> interfaz de lecciones muestra navegación correctamente
- Location: e2e\tests\lesson-viewer.spec.ts:32:7
...
Call log:
  - navigating to "http://localhost:3000/learn/test-course-id", waiting until "load"
