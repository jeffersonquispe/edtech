...
- Name: integration.spec.ts >> Integration Tests - Complete Flows >> roles separados: estudiante vs instructor
- Location: e2e\tests\integration.spec.ts:47:7

# Error details

```
Test timeout of 30000ms exceeded while setting up "studentContext".
```
