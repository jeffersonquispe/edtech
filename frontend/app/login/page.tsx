      ...
      <div className="w-full max-w-sm animate-fade-in-up">
        <div className="bg-white rounded-2xl shadow-xl shadow-black/5 border border-black/5 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <h1 className="text-2xl font-bold mb-1 text-center">Bienvenido de nuevo</h1>
            <p className="text-zinc-500 text-sm text-center mb-7">Ingresa a tu cuenta para continuar</p>
            ...
            <p className="text-center text-sm text-zinc-500 mt-6">
              ¿No tienes cuenta?{' '}
              <Link href="/signup" className="font-semibold text-[#5B4FFF] hover:text-[#4A3EE0] transition-colors">
                Regístrate
              </Link>
            </p>
          </div>
